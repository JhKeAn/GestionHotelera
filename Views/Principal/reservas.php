...
<section class="news-area ptb-100">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<input type="text" id="fechallegada" value="<?php $data['disponible']['fechallegada'] ?>">
						<input type="text" id="fechasalida" value="<?php $data['disponible']['fechasalida'] ?>">
						<input type="text" id="habitacion" value="<?php $data['disponible']['habitacion'] ?>">
						<div id="calendar"></div>
				</div>
			</div>
		</section>
...
section class="news-area ptb-100">
    ...
    <script src="<?php echo RUTA_PRINCIPAL . 'Assets/Principal/js/reserva.js'?>"></script>
