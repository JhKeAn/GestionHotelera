                    ...
                    <div class="check-content">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker-1">
                                ...
                                <input type="text" class="form-control" value="<?php echo date('y-m-d') ?>" id="fechallegada" name="fechallegada" >
                    ...
                    <div class="check-content">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker-2">
                                <i class="flaticon-calendar"></i>
                                <input type="text" class="form-control" id="fechasalida" value="<?php echo date('y-m-d') ?>" name="fechasalida">
                                <span class="input-group-addon">
                                    <i class="glyphicon glyphicon-th"></i>
                                </span>
                            </div>
...
<?php  } ?>
<script src="<?php echo RUTA_PRINCIPAL . 'Assets/Principal/js/index.js'?>"></script>
</body>
